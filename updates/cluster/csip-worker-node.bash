...
sed -i '/./{H;$!d} ; x ; /# BEGIN ETH0 BLOCK/,//d' /etc/dhcp/dhcpd.conf

# Removing interface eth0 from dhcp server
echo "REMOVING ETH1 INTERFACE" 
sed -i 's/INTERFACESv4="eth0 eth1"/INTERFACESv4="eth1"/g' /etc/default/isc-dhcp-server
