        ...
        do
            case "$1" in
                ...
                -v|--version-override)
                    ...
                    ;;
                -d|disable)
                    crontab -l | grep -v 'root /usr/bin/hd-image update | /usr/bin/logger -t Updater'  | crontab -
                    echo "Automatic updates disabled"
                    exit
                    ;;
                -e|enable)
                    (crontab -l ; echo "* 5 * * * * root /usr/bin/hd-image update | /usr/bin/logger -t Updater") | crontab -
